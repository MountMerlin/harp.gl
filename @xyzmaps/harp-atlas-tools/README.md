...
In order to simplify paths you may copy it to you current folder or create sym-link to it (you do not need to do it if your work in the root package directory: `@xyzmaps/harp-atlas-tools`):
