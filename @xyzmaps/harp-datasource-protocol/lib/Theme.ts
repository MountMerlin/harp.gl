 ...
 */
import { Vector3Like } from "@xyzmaps/harp-geoutils/lib/math/Vector3Like";
 ...
 * {@link @xyzmaps/harp-mapview#DataSource} should be rendered.
 *
 * @remarks
 ...
 * {@link @xyzmaps/harp-mapview#MapView} via {@link @xyzmaps/harp-mapview#MapViewtheme}.
 */
export type Styles = Style[];

/**
 * The object that defines what way an item of a {@link @xyzmaps/harp-mapview#DataSource}
