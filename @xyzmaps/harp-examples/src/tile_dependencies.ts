...
import { DebugTileDataSource } from "@xyzmaps/harp-debug-datasource";
...
import { CopyrightElementHandler, MapView, PickResult, Tile } from "@xyzmaps/harp-mapview";
import {
    DataProvider,
    TileDataSource,
...
/**
 * This example shows how to use the {@link @xyzmaps/harp-mapview#Tile.dependencies} property to ensure
 ...
 * ```
 * {@link @xyzmaps/harp-mapview#Tile}s that contain the geometry from another Tile need to have a
 * reference to the Tile containing the overlapping geometry, this is achieved using the
 * `dependencies` property of the {@link @xyzmaps/harp-datasource-protocol#DecodedTile}
 * ```typescript
