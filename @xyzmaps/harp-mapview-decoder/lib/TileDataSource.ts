...
import { ThemeLoader } from "@xyzmaps/harp-mapview/lib/ThemeLoader";
import { ILogger, LoggerManager } from "@xyzmaps/harp-utils";
...
export class TileDataSource<TileType extends Tile = Tile> extends DataSource {
     ...
     *
     * Applies new {@xyzmaps/harp-datasource-protocol StyleSet} and definitions from theme only
