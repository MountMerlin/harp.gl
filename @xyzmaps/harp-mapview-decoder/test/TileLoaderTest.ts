...
import { DecodedTile, Geometry, ITileDecoder, TileInfo } from "@xyzmaps/harp-datasource-protocol";
import {
    Projection,
    TileKey,
    TilingScheme,
...
import { DataSource, MapView, Statistics, Tile, TileLoaderState } from "@xyzmaps/harp-mapview";
...
describe("TileLoader", function () {
    ...
    describe("tile load", function () {
        ...
        // @xyzmaps/harp-mapview package, and trying to add package which contains the TileLoader
