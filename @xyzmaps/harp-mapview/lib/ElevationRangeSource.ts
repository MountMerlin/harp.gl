 ...
 */
import { TilingScheme } from "@xyzmaps/harp-geoutils";
...
export interface ElevationRangeSource {
    /**
     * Compute the elevation range for a given {@link @xyzmaps/harp-geoutils#TileKey}.
     ...
     * the same {@link @xyzmaps/harp-geoutils#TilingScheme}.
     */
