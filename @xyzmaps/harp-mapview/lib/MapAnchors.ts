 ...
 */
import { StylePriority } from "@xyzmaps/harp-datasource-protocol";
import {
    GeoCoordinates,
 ...
 * given {@link @xyzmaps/harp-geoutils#GeoCoordinates}.
 *
 * @remarkks
 * @example
 * Example:
...
export type MapAnchor<T extends THREE.Object3D = THREE.Object3D> = T & {
    /**
     * The position of this [[MapAnchor]] in {@link @xyzmaps/harp-geoutils#GeoCoordinates}.
     * @deprecated Use [[anchor]] instead.
     */
    geoPosition?: GeoCoordinates;

    /**
     * The anchor of this Object3D in {@link @xyzmaps/harp-geoutils#GeoCoordinates}
