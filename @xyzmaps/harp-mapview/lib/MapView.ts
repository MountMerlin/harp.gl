...
export class MapView extends EventDispatcher {
    ...
    /**
     * {@link @xyzmaps/harp-utils#UriResolver} used to resolve application/deployment
     ...
     *
     * @param projection - The {@link @xyzmaps/harp-geoutils#Projection} instance to use.
     */
     ...
     *  - if the tilt is high and projection is {@link @xyzmaps/harp-geoutils#sphereProjection}`
     ...
     * | ------               | ------      | --------
     * | {@link @xyzmaps/harp-geoutils#GeoBox}           | _defined_   | `params.target` is used
     * | {@link @xyzmaps/harp-geoutils#GeoBox}           | `undefined` | `bounds.center` is used as new `target`
     * | {@link @xyzmaps/harp-geoutils#GeoBoxExtentLike} | `undefined` | current `MapView.target` is used
     * | {@link @xyzmaps/harp-geoutils#GeoBoxExtentLike} | _defined_   | `params.target` is used
    ...
    /**
     * Moves the camera to the specified {@link @xyzmaps/harp-geoutils#GeoCoordinates},
     ...
     * in {@link @xyzmaps/harp-map-controls#MapControls}, where the center of
     ...
     *
     * @param pos - The position as a {@link @xyzmaps/harp-geoutils#GeoCoordLike} or
    ...
    /**
     * Returns the {@link @xyzmaps/harp-geoutils#GeoCoordinates} from the
