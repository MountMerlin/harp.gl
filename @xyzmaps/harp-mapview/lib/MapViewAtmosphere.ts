...
import { EarthConstants, Projection, ProjectionType } from "@xyzmaps/harp-geoutils";
import { GroundAtmosphereMaterial, SkyAtmosphereMaterial } from "@xyzmaps/harp-materials";
import { assert } from "@xyzmaps/harp-utils";
...
export class MapViewAtmosphere {
     ...
     * {@link @xyzmaps/harp-datasource-protocol#Theme} instance provided.
     *
