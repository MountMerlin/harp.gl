 ...
 */
import { Fog } from "@xyzmaps/harp-datasource-protocol";
import { HighPrecisionLineMaterial } from "@xyzmaps/harp-materials";
import { RawShaderMaterial } from "@xyzmaps/harp-materials/lib/RawShaderMaterial";
import { assert, MathUtils } from "@xyzmaps/harp-utils";
...
export class MapViewFog {
    ...
    /**
     * Sets the fog depending on the {@link @xyzmaps/harp-datasource-protocol#Theme}
     ...
     *
     * @param theme - A {@link @xyzmaps/harp-datasource-protocol#Theme} instance.
     */
    reset(fog?: Fog) {
