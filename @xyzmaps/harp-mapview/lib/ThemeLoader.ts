...
import { isJsonExpr } from "@xyzmaps/harp-datasource-protocol";
import {
    Definitions,
    getDefinitionValue,
    getStyles,
    ...
    Styles,
    Theme
} from "@xyzmaps/harp-datasource-protocol/lib/Theme";
import {
    composeUriResolvers,
    ContextLogger,
    getAppBaseUrl,
...
/**
 * Options to customize {@link @xyzmaps/harp-datasource-protocol#Theme} loading process.
 *
...
export interface ThemeLoadOptions {
     ...
     * through [{@link @xyzmaps/harp-datasource-protocol#Theme}s `extends` property.
     *
...
export class ThemeLoader {
    /**
     * Loads a {@link @xyzmaps/harp-datasource-protocol#Theme} from a
     ...
     * providing {@link @xyzmaps/harp-utils#UriResolver} using {@link ThemeLoadOptions.uriResolver}
     * option.
     *
     * @param theme - {@link @xyzmaps/harp-datasource-protocol#Theme} instance or theme URL
     *                to the theme.
     ...
     *
     * Loads a {@link @xyzmaps/harp-datasource-protocol#Theme} from a remote resource,
    ...
    /**
     * Resolves all {@link @xyzmaps/harp-datasource-protocol#Theme}'s relatives URLs
     * to full URL using the {@link @xyzmaps/harp-datasource-protocol#Theme}'s URL
     * (see: https://www.w3.org/TR/WD-html40-970917/htmlweb.html#h-5.1.2).
     *
     * This method mutates original `theme` instance.
     *
     * @param theme - The {@link @xyzmaps/harp-datasource-protocol#Theme} to resolve.
     */
    ...
    /**
     * Expand all `ref` expressions in {@link @xyzmaps/harp-datasource-protocol#Theme}
     ...
     * its base {@link @xyzmaps/harp-datasource-protocol#Theme}.
     *
     * @param theme - {@link @xyzmaps/harp-datasource-protocol#Theme} object
     * @param options - Optional, a {@link ThemeLoadOptions} objects
     *                  containing any custom settings for
     *                  this load request.
     */
