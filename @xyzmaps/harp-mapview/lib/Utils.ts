...
import { EarthConstants } from "@xyzmaps/harp-geoutils/lib/projection/EarthConstants";
import { assert, DOMUtils, LoggerManager } from "@xyzmaps/harp-utils";
 ...
 * {@link @xyzmaps/harp-map-controls#MapControls} never matches
 * exactly the target due to the precision loss caused by the
 * conversion from zoom level to camera distance (done in
 * {@link (MapView.lookAt:WITH_PARAMS)} and {@link @xyzmaps/harp-map-controls#MapControls})
...
export namespace MapViewUtils {
    ...
    /**
     * Returns the {@link @xyzmaps/harp-geoutils#GeoCoordinates} of the camera,
     ...
     * @internal
     *
     * Return `GeoPoints` bounding {@link @xyzmaps/harp-geoutils#GeoBox}
     * applicable for {@link getFitBoundsDistance}.
     *
     * @returns {@link @xyzmaps/harp-geoutils#GeoCoordinates} set that covers `box`
     */
     ...
     * @param projection - The {@link @xyzmaps/harp-geoutils#Projection} used to
     ...
     *
     * @param projection - The {@link @xyzmaps/harp-geoutils#Projection} used when
    ...
    /**
     * @deprecated Use {@link @xyzmaps/harp-utils#DOMUtils.getBrowserLanguages}
     */
...
export namespace TileOffsetUtils {
    /**
     * @deprecated Use {@link @xyzmaps/harp-geoutils#TileKeyUtils.getKeyForTileKeyAndOffset}.
     */
    ...
    /**
     * @deprecated Use {@link @xyzmaps/harp-geoutils#TileKeyUtils.getParentKeyFromKey}.
     */
