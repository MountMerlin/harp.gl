...
import { LRUCache } from "@xyzmaps/harp-lrucache";
import { assert, MathUtils, TaskQueue } from "@xyzmaps/harp-utils";
...
export class VisibleTileSet {
    ...
    /**
     * Dispose tiles that are marked for removal by {@link @xyzmaps/harp-lrucache#LRUCache} algorithm.
     */
    disposePendingTiles() {
