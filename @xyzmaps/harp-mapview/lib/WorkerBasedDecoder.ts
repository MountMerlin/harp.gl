...
import { Projection, TileKey } from "@xyzmaps/harp-geoutils";
...
export class WorkerBasedDecoder implements ITileDecoder {
     ...
     *
     * @remarks
     * Invokes {@link @xyzmaps/harp-datasource-protocol#DecodeTileRequest} on
    ...
    /**
     * Get {@link @xyzmaps/harp-datasource-protocol#TileInfo} from tile decoder service in worker.
     *
     * @remarks
     * Invokes {@link @xyzmaps/harp-datasource-protocol#TileInfoRequest}
     ...
     *
     * @remarks
     * Broadcasts {@link @xyzmaps/harp-datasource-protocol#ConfigurationMessage}
