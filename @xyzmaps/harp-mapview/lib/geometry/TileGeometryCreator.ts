...
import {
    ...
    OperatorDescriptor
} from "@xyzmaps/harp-datasource-protocol/lib/ExprEvaluator";
import { EarthConstants, ProjectionType } from "@xyzmaps/harp-geoutils";
import {
    EdgeMaterial,
...
/**
 * Support class to create geometry for a {@link Tile} from a {@link @xyzmaps/harp-datasource-protocol#DecodedTile}.
 * @internal
 */
export class TileGeometryCreator {
     ...
     * @param decodedTile - The {@link @xyzmaps/harp-datasource-protocol#DecodedTile}.
     * @param textFilter -: Optional filter. Should return true for any text technique that is
     *      applicable.
     */
    createTextElements(
    ...
    /**
     * Gets the attachments of the given {@link @xyzmaps/harp-datasource-protocol#DecodedTile}.
     *
     * @param decodedTile - The {@link @xyzmaps/harp-datasource-protocol#DecodedTile}.
     */
