 ...
 */
import { MemoryUsage } from "@xyzmaps/harp-text-canvas";
import { Math2D } from "@xyzmaps/harp-utils";
...
export class BoxBuffer {
    /**
     * {@link @xyzmaps/harp-datasource-protocol#BufferAttribute} holding the `BoxBuffer` position data.
     */
    private m_positionAttribute?: THREE.BufferAttribute;

    /**
     * {@link @xyzmaps/harp-datasource-protocol#BufferAttribute} holding the `BoxBuffer` color data.
     */
    private m_colorAttribute?: THREE.BufferAttribute;

    /**
     * {@link @xyzmaps/harp-datasource-protocol#BufferAttribute} holding the `BoxBuffer` uv data.
     */
    private m_uvAttribute?: THREE.BufferAttribute;

    /**
     * {@link @xyzmaps/harp-datasource-protocol#BufferAttribute} holding the `BoxBuffer` index data.
     */
     ...
     * {@link @xyzmaps/harp-datasource-protocol#BufferAttribute}s.
     */
    ...
    /**
     * Creates a new {@link @xyzmaps/harp-datasource-protocol#Geometry} object
    ...
    private isPixelTransparent(
        ...
        // @ts-ignore
        const { width, height } = image instanceof SVGImageElement ? image.getBBox() : image as unknown;
        const x = width * u;
        const y = height * v;
