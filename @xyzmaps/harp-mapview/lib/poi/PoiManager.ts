...
import { assert, assertExists, LoggerManager } from "@xyzmaps/harp-utils";
...
/**
 * Interface for the {@link @xyzmaps/harp-datasource-protocol#ImageTexture}s
 ...
 * {@link @xyzmaps/harp-datasource-protocol#PoiGeometry} objects
 * from the {@link @xyzmaps/harp-datasource-protocol#DecodedTile},
...
export class PoiManager {
     ...
     *                      {@link @xyzmaps/harp-datasource-protocol#PoiGeometry}
     ...
     *
     * @remarks
     * Creates an {@link @xyzmaps/harp-datasource-protocol#ImageTexture}
    ...
    /**
     * Add an {@link @xyzmaps/harp-datasource-protocol#ImageTexture} such that it
     * is available as a named entity for techniques in theme files.
     *
     * @param imageTexture - {@link @xyzmaps/harp-datasource-protocol#ImageTexture}
    ...
    /**
     * Return the {@link @xyzmaps/harp-datasource-protocol#ImageTexture}
     * registered under the specified name.
     *
     * @param name - Name of the {@link @xyzmaps/harp-datasource-protocol#ImageTexture}.
     */
