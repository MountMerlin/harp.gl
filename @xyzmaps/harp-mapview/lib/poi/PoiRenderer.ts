 ...
 */
import { Env, getPropertyValue, ImageTexture } from "@xyzmaps/harp-datasource-protocol";
import { IconMaterial } from "@xyzmaps/harp-materials";
import { MemoryUsage } from "@xyzmaps/harp-text-canvas";
import { assert, LoggerManager, Math2D } from "@xyzmaps/harp-utils";
 ...
 * ({@link @xyzmaps/harp-datasource-protocol#ImageTexture}).
 *
...
export class PoiRenderer {
     ...
     * @param imageTexture - Shared {@link @xyzmaps/harp-datasource-protocol#ImageTexture},
