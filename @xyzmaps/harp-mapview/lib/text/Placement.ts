...
import { Env, getPropertyValue, PoiTechnique } from "@xyzmaps/harp-datasource-protocol";
import { OrientedBox3, Projection, ProjectionType } from "@xyzmaps/harp-geoutils";
import {
    hAlignFromPlacement,
    HorizontalPlacement,
...
import { assert, Math2D, MathUtils } from "@xyzmaps/harp-utils";
 ...
 * @param env - The {@link @xyzmaps/harp-datasource-protocol#Env} used
 ...
 * @param scale - Scale factor to be applied to label dimensions.
 * @param textCanvas - The text canvas where the label will be placed.
 * @param env - The {@link @xyzmaps/harp-datasource-protocol#Env}
