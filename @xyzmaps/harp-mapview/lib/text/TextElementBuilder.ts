...
import { assert, LoggerManager, MathUtils } from "@xyzmaps/harp-utils";
...
/**
 * Constructs {@link TextElement} objects from {@link @xyzmaps/harp-datasource-protocol/Technique},
...
export class TextElementBuilder {
     ...
     * Constructor
     *
     * @param m_env - The {@link @link @xyzmaps/harp-datasource-protocol#MapEnv} used to evaluate
     * technique properties.
     * @param m_styleCache - To cache instances of {@link @xyzmaps/harp-text-canvas/TextRenderStyle}
     * and {@link @xyzmaps/harp-text-canvas/TextLayoutStyle}.
     */
    constructor(
     ...
     *
     * @param technique - The {@link @xyzmaps/harp-datasource-protocol/Technique}.
     * @return This builder.
     */
    withTechnique(
