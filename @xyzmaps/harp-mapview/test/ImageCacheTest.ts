 ...
 */
import { getTestResourceUrl, silenceLoggingAroundFunction } from "@xyzmaps/harp-test-utils";
import { LogLevel } from "@xyzmaps/harp-utils";
...
describe("MapViewImageCache", function () {
    ...
    it("#addImage with url", function () {
        ...
        const imageUrl = getTestResourceUrl("@xyzmaps/harp-mapview", "test/resources/headshot.png");
...
describe("ImageCache", function () {
    ...
    if (typeof document !== "undefined") {
        ...
        image.src = getTestResourceUrl("@xyzmaps/harp-mapview", "test/resources/headshot.png");
