...
const texturePath = getTestResourceUrl("@xyzmaps/harp-mapview", "test/resources/headshot.png");
const jpgTexturePath = getTestResourceUrl("@xyzmaps/harp-mapview", "test/resources/headshot.jpg");
