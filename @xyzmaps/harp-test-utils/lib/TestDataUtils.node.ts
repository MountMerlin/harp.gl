...
// @xyzmaps:check-imports:environment:node
 ...
 *
 * @param moduleName -: module name, `@xyzmaps/<module_name>` (e.g. @xyzmaps/harp-vectortile-datasource)
 ...
 * purposes:
 *  * `@xyzmaps/${module}/test/resources`
 *  * `@xyzmaps/${module}/resources`
 *
 ...
 *
 * @param module -: module name, @xyzmaps/<module_name> (e.g. @xyzmaps/harp-vectortile-datasource)
 * @param fileName -: the requested resource,
 *                  (e.g. @xyzmaps/harp-vectortile-datasource/test/resources/berlin.bin)
 */
