 ...
 */
import { GeometryKind, GeometryKindSet } from "@xyzmaps/harp-datasource-protocol";
import { MapEnv } from "@xyzmaps/harp-datasource-protocol/index-decoder";
...
export interface OmvFeatureFilter {
     ...
     * @deprecated See {@link @xyzmaps/here-datasource-protocol/BaseTechniqueParams.kind}.
     */
