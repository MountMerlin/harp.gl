 ...
 */
import { DecoderOptions, OptionsMap, WorkerServiceProtocol } from "@xyzmaps/harp-datasource-protocol";
import { EarthConstants, TileKey, webMercatorTilingScheme } from "@xyzmaps/harp-geoutils";
import { DataSourceOptions, Tile } from "@xyzmaps/harp-mapview";
import {
    DataProvider,
    TileDataSource,
    TileDataSourceOptions,
    TileFactory
} from "@xyzmaps/harp-mapview-decoder";
import { getOptionValue, LoggerManager } from "@xyzmaps/harp-utils";
...
export interface VectorTileFactory {
    /** Create an instance of {@link @xyzmaps/harp-mapview#Tile} or a subclass. */
...
export interface VectorTileDataSourceParameters
    ...
    /**
     * Optional, custom factory for {@link @xyzmaps/harp-mapview#Tile} instances created
