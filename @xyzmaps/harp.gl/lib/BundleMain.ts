...
import { ConcurrentDecoderFacade, ConcurrentTilerFacade } from "@xyzmaps/harp-mapview";
import { WorkerLoader } from "@xyzmaps/harp-mapview/lib/workers/WorkerLoader";
import { baseUrl, UriResolver } from "@xyzmaps/harp-utils";
    ...
    if (!baseScriptUrl) {
        ...
        console.error(
            `harp.js: Unable to determine default location of 'harp-decoders(min).js'. ` +
                `See https://github.com/heremaps/harp.gl/@xyzmaps/harp.gl.`
        );
    }
